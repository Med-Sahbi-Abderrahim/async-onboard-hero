...
export default function ClientPortalBilling() {
  ...
  const handleInvoiceActionSuccess = () => {
    ...
    <div className="min-h-screen gradient-hero p-4 md:p-8 animate-fade-in flex flex-col">
            ...
            {loading ? (
              ...
              invoices.map((invoice, index) => (
                ...
                >
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 rounded-xl bg-primary/5 border border-primary/10 mb-4">
                      <div>
      ...
      {selectedInvoice && (
        <InvoiceActionsModal
          ...
          onSuccess={handleInvoiceActionSuccess}
        />
      )}
    </div>
  );
