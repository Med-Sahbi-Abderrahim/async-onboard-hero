  ...
  const onSubmit = async (values: SignupFormValues) => {
    ...
    try {
      ...
      if (inviteCode && data.user) {
        const { data: inviteResult, error: inviteError } = await supabase.rpc("use_early_access_invite", {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              {inviteCode
                ? "🎉 You have an early access invite! Sign up to get 30 days of Pro."
                : "Get started with Kenly today"}
            </p>
          </div>
