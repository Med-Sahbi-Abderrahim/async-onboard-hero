...
export function ClientPortalTracker() {
  ...
  useEffect(() => {
    sessionStorage.setItem("lastClientPortalRoute", location.pathname);
  }, [location.pathname]);
...
export default function ClientPortal() {
  ...
  const quickLinks = [
    {
      title: "Files",
      icon: FileUp,
      path: `/client-portal/${client.organization_id}/files`,
      description: "Upload and view files",
    },
    {
      title: "Contracts",
      icon: FileText,
      path: `/client-portal/${client.organization_id}/contracts`,
      description: "Review and sign contracts",
    },
    {
      title: "Billing",
      icon: CreditCard,
      path: `/client-portal/${client.organization_id}/billing`,
      description: "View invoices and payments",
    },
    {
      title: "Meetings",
      icon: Calendar,
      path: `/client-portal/${client.organization_id}/meetings`,
      description: "Upcoming meetings",
    },
    {
      title: "Tasks",
      icon: CheckCircle2,
      path: `/client-portal/${client.organization_id}/tasks`,
      description: "View your tasks",
    },
    {
      title: "Feedback",
      icon: MessageSquare,
      path: `/client-portal/${client.organization_id}/feedback`,
  ...
  return (
    <>
      <WelcomeModal open={showWelcome} onComplete={handleCompleteOnboarding} clientName={client?.full_name} />
        ...
        <div className="flex-1 p-4 md:p-8">
          <div className="max-w-6xl mx-auto space-y-6 md:space-y-8">
            ...
            <div className="text-center space-y-3 py-8 animate-slide-up">
              ...
              <Badge
                className={`${statusColors[client.project_status as keyof typeof statusColors]} text-sm px-4 py-1.5 shadow-soft`}
              >
            ...
            >
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  Follow these steps to unlock the full potential of your portal
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  <div className="flex items-start gap-5 group cursor-pointer hover-lift p-4 rounded-xl transition-all">
                    <div className="rounded-full gradient-primary text-primary-foreground w-12 h-12 flex items-center justify-center font-bold text-lg shadow-medium group-hover:shadow-glow transition-all shrink-0">
                      1
                    </div>
                    <div className="flex-1">
                      <h3 className="font-semibold text-xl mb-1">Upload Your Files</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        Share documents and assets with your team securely
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5 group cursor-pointer hover-lift p-4 rounded-xl transition-all">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        Complete any pending agreements with ease
                      </p>
                    </div>
                  </div>
                  <div className="h-px bg-gradient-to-r from-transparent via-border to-transparent" />
